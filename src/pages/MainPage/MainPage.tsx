      ...
      >
        <div className={'main-page__description-block-head'}>
          ...
          <div className={'main-page__description-block-feedback-wrap'}>
            <Button className={'main-page__description-block-feedback-button'}>
              Feedback
            </Button>
          </div>
        </div>
        ...
        >
          ...
          <p>
            ...
            into an old tavern, walk along the widest and longest streets of the
            city and even find out that Tallinn is a lame city!
          </p>
          <p>
